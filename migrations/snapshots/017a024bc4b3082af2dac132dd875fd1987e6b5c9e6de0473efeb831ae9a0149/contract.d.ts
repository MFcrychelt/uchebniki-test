...
export type StorageHash =
  StorageHashBase<'017a024bc4b3082af2dac132dd875fd1987e6b5c9e6de0473efeb831ae9a0149'>;
export type ExecutionHash =
  ExecutionHashBase<'2398ed965a4202f87ddafa609137bee4b34aec26cf9f3c115dda14e78d2d0e9b'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly User: {
      readonly id: CodecTypes['pg/text@1']['output'];
      readonly role: 'STUDENT' | 'LIBRARIAN';
...
export namespace Models {
  export type public_User = {
    ...
    qrToken: CodecTypes['pg/text@1']['output'] | null;
    ...
    class: public_Class | null;
    issuedByMe: public_Loan[];
    loans: public_Loan[];
    readonly [RelationKeys]?: 'class' | 'issuedByMe' | 'loans';
  };
  export type public_Class = {
    id: CodecTypes['pg/text@1']['output'];
    name: CodecTypes['pg/text@1']['output'];
    books: public_ClassBook[];
    students: public_User[];
    readonly [RelationKeys]?: 'books' | 'students';
  };
  export type public_Book = {
    ...
    classes: public_ClassBook[];
    loans: public_Loan[];
    readonly [RelationKeys]?: 'classes' | 'loans';
  };
  export type public_ClassBook = {
    classId: CodecTypes['pg/text@1']['output'];
    bookId: CodecTypes['pg/text@1']['output'];
    book: public_Book;
    class: public_Class;
    readonly [RelationKeys]?: 'book' | 'class';
  };
  export type public_Loan = {
    id: CodecTypes['pg/text@1']['output'];
    studentId: CodecTypes['pg/text@1']['output'];
    bookId: CodecTypes['pg/text@1']['output'];
    librarianId: CodecTypes['pg/text@1']['output'] | null;
    ...
    book: public_Book;
    librarian: public_User | null;
    student: public_User;
    readonly [RelationKeys]?: 'book' | 'librarian' | 'student';
  };
}
...
export declare const models: {
  public: {
    ...
    ClassBook: Models.public_ClassBook;
      ...
      readonly public: {
        ...
        readonly entries: {
          ...
          readonly valueSet: {
            ...
            readonly Role: {
              readonly kind: 'valueSet';
              readonly values: readonly ['STUDENT', 'LIBRARIAN'];
            };
          };
        };
      };

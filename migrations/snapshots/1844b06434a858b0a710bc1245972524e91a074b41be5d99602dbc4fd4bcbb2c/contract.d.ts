...
export type StorageHash =
  StorageHashBase<'1844b06434a858b0a710bc1245972524e91a074b41be5d99602dbc4fd4bcbb2c'>;
export type ExecutionHash =
  ExecutionHashBase<'2a800ec5f2e91dfb31fe750d99329da0fe840d7bd6fd60de4471ba261da692ee'>;
...
export type FieldOutputTypes = {
  readonly public: {
    ...
    readonly Book: {
      ...
      readonly grade: CodecTypes['pg/int4@1']['output'] | null;
    };
    ...
    readonly BookSetItem: {
      readonly setId: CodecTypes['pg/text@1']['output'];
      readonly bookId: CodecTypes['pg/text@1']['output'];
    };
    readonly Class: {
      readonly id: CodecTypes['pg/text@1']['output'];
...
export type FieldInputTypes = {
  readonly public: {
    ...
    readonly Book: {
      ...
      readonly grade: CodecTypes['pg/int4@1']['input'] | null;
    };
    readonly BookRequest: {
      readonly id: CodecTypes['pg/text@1']['input'];
    ...
    readonly BookSetItem: {
      readonly setId: CodecTypes['pg/text@1']['input'];
      readonly bookId: CodecTypes['pg/text@1']['input'];
    };
    readonly Class: {
      readonly id: CodecTypes['pg/text@1']['input'];
...
export type StorageColumnTypes = {
  readonly public: {
    ...
    readonly book_set_items: {
      readonly book_id: CodecTypes['pg/text@1']['output'];
      readonly set_id: CodecTypes['pg/text@1']['output'];
    };
    readonly book_sets: {
      readonly created_at: CodecTypes['pg/timestamptz-temporal@1']['output'];
      readonly id: CodecTypes['pg/text@1']['output'];
...
export type StorageColumnInputTypes = {
  readonly public: {
    ...
    readonly book_set_items: {
      readonly book_id: CodecTypes['pg/text@1']['input'];
      readonly set_id: CodecTypes['pg/text@1']['input'];
    };
    readonly book_sets: {
      readonly created_at: CodecTypes['pg/timestamptz-temporal@1']['input'];
      readonly id: CodecTypes['pg/text@1']['input'];
        ...
        readonly entries: {
          readonly table: {
            ...
            readonly book_set_items: {
              ...
              primaryKey: { readonly columns: readonly ['set_id', 'book_id'] };
              uniques: readonly [];
              indexes: readonly [
                {
                  readonly name: 'book_set_items_set_id_idx_8a237342';
                  readonly prefix: 'book_set_items_set_id_idx';
                  readonly columns: readonly ['set_id'];
                  readonly unique: false;
                },
                {
                  readonly name: 'book_set_items_book_id_idx_abfe80f1';
                  readonly prefix: 'book_set_items_book_id_idx';
                  readonly columns: readonly ['book_id'];
                  readonly unique: false;
                },
              ];
              foreignKeys: readonly [
                {
                  readonly source: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'book_set_items';
                    readonly columns: readonly ['set_id'];
                  };
                  readonly target: {
                    readonly namespaceId: 'public' & NamespaceId;
                    readonly tableName: 'book_sets';
                    readonly columns: readonly ['id'];
                  };
                },
                {
...
> & {
  ...
  readonly roots: {
    ...
    readonly book_sets: { readonly namespace: 'public' & NamespaceId; readonly model: 'BookSet' };
    readonly book_set_items: {
      readonly namespace: 'public' & NamespaceId;
      readonly model: 'BookSetItem';
    };
    readonly book_requests: {
      readonly namespace: 'public' & NamespaceId;
      ...
      readonly public: {
        readonly models: {
          ...
          readonly BookSetItem: {
            ...
            readonly storage: {
              readonly table: 'book_set_items';
              readonly namespaceId: 'public';
              readonly fields: {
                readonly setId: { readonly column: 'set_id' };
                readonly bookId: { readonly column: 'book_id' };
              };
            };
          };
